...
#### 234 lines
# Removed variable checks - initially - 360
# Removed cloud-init section
# Removed ArgoCD and password retrieval
# Removed Istioctl install and YAML - 292
# Removed ArgoCD Nodeport - 282
# Remove ArgoCD Nodeport - 262
# Cleanup & Removed LOKI Gateway and VS service - 216
# Added ISTIOCTL install and YAML - 256
# Removed ISTIOCTL and YAML - 234