...
|------|-------------|------|---------|:--------:|
| <a name="input_password_length"></a> [password\_length](#input\_password\_length) | the length of the password | `number` | `16` | no |
| <a name="input_secret_manager_name"></a> [secret\_manager\_name](#input\_secret\_manager\_name) | the name of the secret manager | `string` | n/a | yes |
